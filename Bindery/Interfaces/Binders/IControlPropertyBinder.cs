...
namespace Bindery.Interfaces.Binders
{
        ...
        where TControl : IBindableComponent
    {
        ...
        /// </summary>
        /// <param name="sourceMember">Expression that specifies the source property</param>
        /// <param name="convertToControlPropertyType">
        ///     Function for converting the source property value to the control property's
        ///     type
        /// </param>
        /// <returns>The control binder</returns>
        ...
        /// </summary>
        /// <param name="sourceMember">Expression that specifies the source property</param>
        /// <param name="convertToSourcePropertyType">
        ///     Function for converting the control property value to the source property's
        ///     type
        /// </param>
        /// <param name="dataSourceUpdateMode">(optional) When the source property is updated</param>
        /// <returns>The control binder</returns>
